...
//
//    private List<Manager> vrachtwagenList; //define inside methode otherwise null
//    private Button deleteBtn;
//    private Button toevoegenBtn;
//    private werkroosterGrid<Manager> werkroosterGrid;
//    private long rowId;
//    private Object rowItem;
//
//    public void addTable() {
//        vrachtwagenList = repository.findAll();
//        werkroosterGrid = crudUI.managerGrid;
...
//
//        werkroosterGrid.setCaption("Managers");
...
//
//        werkroosterGrid.addColumn(Manager::getID)
//                .setCaption("Id")
//                .setExpandRatio(2);
//
//        werkroosterGrid.addColumn(Manager::getVoornaam)
//                .setEditorComponent(taskField1, this::setVoornaam)
//                .setCaption("Voornaam")
//                .setExpandRatio(2);
//
//        werkroosterGrid.addColumn(Manager::getTussenvoegsel)
//                .setEditorComponent(taskField2, this::setTussenvoegsel)
//                .setCaption("Tussenvoegsel")
//                .setExpandRatio(2);
//
//        werkroosterGrid.addColumn(Manager::getAchternaam)
//                .setEditorComponent(taskField3, this::setAchternaam)
//                .setCaption("Achternaam")
//                .setExpandRatio(2);
//
//        werkroosterGrid.addColumn(Manager::getUser_Id)
//                .setEditorComponent(taskField4, this::setUser_Id)
//                .setCaption("Inlognaam")
//                .setExpandRatio(2);
//
//        werkroosterGrid.addColumn(Manager::getWachtwoord)
